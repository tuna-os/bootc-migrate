...
pub fn ostree_to_composefs(sys: SystemInfo) -> PreflightReport {
    ...
    PreflightReport {
        ...
        container_storage_free_bytes: sys.container_storage_free_bytes,
        container_storage_path: sys.container_storage_path,
        var_is_separate_mount: sys.var_is_separate_mount,
...
mod tests {
    ...
    fn sys_with_esp(detected: bool, free: u64) -> SystemInfo {
        SystemInfo {
            ...
            container_storage_free_bytes: 0,
            container_storage_path: "/".to_string(),
